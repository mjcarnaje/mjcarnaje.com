...
<img 
  src="https://latex.codecogs.com/svg.image?\frac{dS}{dt}=(1-p)\alpha&space;N-\frac{\beta\sqrt{S}I}{N}-\mu\sqrt{S}" 
  alt="Susceptible equation"
/>

<img 
  src="https://latex.codecogs.com/svg.image?\frac{dI}{dt}=\frac{\beta\sqrt{S}I}{N}-(\gamma&plus;\mu)I" 
  alt="Infected equation"
/>

<img 
  src="https://latex.codecogs.com/svg.image?\frac{dR}{dt}=p\alpha&space;N&plus;\gamma&space;I-\mu&space;R" 
...
2. All recovered individuals are not immune to the disease
