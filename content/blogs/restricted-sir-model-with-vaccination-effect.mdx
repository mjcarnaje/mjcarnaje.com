...
1. Susceptible (S) - Population that are susceptible to the disease
2. Infected (I) - Invidivuals that can spread the disease
3. Recovered (R) - Individuals who got the disease but eventually recovered on their own after some time or those vaccinated

* Population - Number of population present
* Birthrate - Natural birth rate of the population, based on the philippines
* Vaccination Rate - Percentage of the total population who are vaccinated
* Deathrate - Natural dirth rate of the population, based on the philippine
* Infection Rate - The constant transmission rate of the disease
* Recovery Rate - The constant recovery rate of the people from the diseases
...
Now here we will compare the results from both equation based and the abm based modelling, note that we are using the epidemic eequilibrium on the reference paper.???

PIctuREEEE RESULTS HAHAHAHA 0% vaccination
1. The first figure shows us the results of both modeling on 0% vaccination. As you can see, both of them share similar pattern when we 90% of the population contracted the disease. They both started at 90% and as time goes by, both of them stabilize the infection rate at about 60% - 70% of total population
2.
3.
4. 
